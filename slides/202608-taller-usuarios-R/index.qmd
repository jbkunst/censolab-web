...
# Inserta una app completa en un bloque Shinylive sin duplicar su código en el
# QMD. La ruta debe ser relativa a este archivo y el chunk debe usar
# `results: asis`.
shinylive_app <- function(path, viewer_height = 620) {
  code <- readLines(path, encoding = "UTF-8", warn = FALSE)
  cat(
    "```{shinylive-r}",
    "#| standalone: true",
    sprintf("#| viewerHeight: %d", viewer_height),
    paste(code, collapse = "\n"),
    "```",
    sep = "\n"
  )
...
code_block("apps/app-01/app.R", c(
  ...
  "6-15" = "La UI declara inputs y outputs.",
...
```{r}
#| results: asis
shinylive_app("apps/app-01/app.R")
```
:::
::::
...
code_block("apps/app-02/app.R", c(
  ...
  "9-19" = "La búsqueda local devuelve primero las series vigentes.",
  "21-36" = "La UI expone búsqueda, selección, rango, gráfico y tabla.",
  "40-72" = "Los controles preparan la consulta sin descargar observaciones.",
  "74-97" = "Sólo el botón llama `get_series()` y actualiza los outputs."
))
```
...
code_block("apps/app-04/app.R", c(
  "32-33" = "Dos valores reactivos representan la vista.",
  "35-44" = "`buscar_series()` devuelve alternativas desde el catálogo local.",
  "46-55" = "`actualizar_dashboard()` descarga y reemplaza el estado reactivo.",
  "57-69" = "Título, gráfico y tabla reaccionan al mismo estado.",
  "74-88" = "Registrar las funciones las convierte en capacidades del modelo."
))
```
...
code_block("apps/app-05/app.R", c(
  "46-52" = "La tool conserva la actualización de la aplicación 4.",
