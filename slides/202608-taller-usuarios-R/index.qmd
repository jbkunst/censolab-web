...
2. **Configuración**  
   Archivos YAML versionados definen las fuentes, las rutas y las opciones de cada etapa del proceso.
...
3. **Pipeline R**  
   Usa las especificaciones YAML para descargar, integrar y enriquecer los datos, simplificar geometrías y generar diccionarios, *metadatos* y *contexto* de uso.

4. **DuckDB**  
   Base de datos analítica y portable, sin un servidor que administrar y con soporte para datos geoespaciales mediante la extensión `spatial`. Puede publicarse en MotherDuck para consultarla de forma remota.
...
## {shiny} · Cinco aplicaciones: de una app básica a un chat con tools
